...
arq = open('relat-'+str(var.NINT1)+'-'+str(var.NINT2)+'-'+str(var.TAPR)+'-'+str(var.TAPR1)+'-'+str(var.MAXITER)+'.txt', 'w')
arq.writelines('')
arq.close()
arq = open('relat-'+str(var.NINT1)+'-'+str(var.NINT2)+'-'+str(var.TAPR)+'-'+str(var.TAPR1)+'-'+str(var.MAXITER)+'.txt', 'r')
...
var.NPAD = 27 #Número de padrões para o teste
conteudo.append('\n\nVERIFICAÇÃO\n')
print('\n\nVERIFICAÇÃO\n')
